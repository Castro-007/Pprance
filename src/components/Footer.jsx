        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2 lg:col-span-1 space-y-4">
            ...
            <div className="flex space-x-4 pt-4">
              {[
                {
                  icon: FaFacebookF,
                  href: "https://www.facebook.com/share/1AVMfomYuA/",
                },
                { icon: FaTwitter, href: "#" },
                {
                  icon: FaInstagram,
                  href: "https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=l05rkc",
                },
              ...
              {[
                ...
                <li key={index}>
                  <div className="text-gray-400 hover:text-blue-500 transition-colors duration-300 flex items-center">
                    <span className="mr-2 text-blue-500 md:hidden">›</span>{" "}
                    {service}
                  </div>
                </li>
              ))}
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
              ...
              {status === "success" && (
                <span className="text-green-400 font-Nunito text-sm">
                  Subscribed successfully
                </span>
              )}
              {status === "error" && (
                <span className="text-red-400 font-Nunito text-sm">
                  Unable to send. Check connection or endpoint.
                </span>
              )}
            </form>
          </div>
